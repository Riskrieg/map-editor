...
import com.riskrieg.editor.view.Editor
        ...
        MenuBar {
            ...
            Menu("Debug", mnemonic = 'D') {
                ...
                Item(
                    ...
                    enabled = model.editView // TODO: Re-enable once a fix for exporting is implemented.
                )
                Item(
                    "Export graph...",
                    icon = painterResource("icons/$themeStr/export_graph.svg"),
                    ...
                    enabled = model.editView // TODO: Re-enable once a fix for it working outside IDE is implemented.
                )
            }
